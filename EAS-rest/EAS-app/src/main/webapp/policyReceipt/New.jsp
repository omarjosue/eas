...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New PolicyReceipt</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{policyReceipt.validateCreate}" value="value"/>
                <h:panelGrid columns="2">
                    <h:outputText value="Folio:"/>
                    <h:inputText id="folio" value="#{policyReceipt.policyReceipt.folio}" title="Folio" required="true" requiredMessage="The folio field is required." />
                ...
                <br />
                <h:commandLink action="#{policyReceipt.create}" value="Create"/>
                <br />
                <br />
