...
<f:view>
    <html>
        <head>
            ...
            <title>New InsurancePolicy</title>
        ...
        <body>
            ...
            <h1>New InsurancePolicy</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{insurancePolicy.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{insurancePolicy.create}" value="Create"/>
                <br />
                <br />
